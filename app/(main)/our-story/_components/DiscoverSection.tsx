...
export default function DiscoverSection() {
  return (
    <section className="bg-background px-[calc(100dvw/24)] py-24">
      <div className="mx-auto grid max-w-[1280px] w-full grid-cols-1 items-center gap-[46px] md:grid-cols-2 md:h-[424px]">
        {/* Logo Card */}
        <div className="flex w-full md:w-[617px] h-[300px] md:h-[424px] items-center justify-center rounded-[32px] bg-[#F3F4F0] p-6">
