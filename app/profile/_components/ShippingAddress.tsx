  ...
  return (
    <div className="mx-auto grid grid-cols-[2fr_1fr] gap-6">
      <div className="flex flex-col items-center justify-start gap-6">
        <div className="flex w-full items-start gap-5 border-primary-background/20 h-60 rounded-xl border p-6">
          ...
          <div className="">
            ...
            <div className="flex items-center justify-start gap-6 ">
                <button className="text-primary-background underline text-lg cursor-pointer hover:text-primary-background/60">Edit</button>
                <button className="text-primary-background underline text-lg cursor-pointer hover:text-primary-background/60">Delete</button>
            </div>
          </div>
        </div>
      </div>
